// Copyright (c) 2025, Almouhana and contributors
// For license information, please see license.txt

frappe.query_reports["Almouhana Financial Statement"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
		...
		},
		{
			...
			label: __("Report"),
			fieldtype: "Select",
			options: ["Profit and Loss Statement", "Balance Sheet", "Cash Flow", "Trial Balance"],
