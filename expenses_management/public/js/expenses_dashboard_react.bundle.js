(() => {
  ...
  // expenses_management/public/js/react_dashboard/index.jsx
  var import_react3 = __toESM(require_react());
  var import_client = __toESM(require_client());

  // expenses_management/public/js/react_dashboard/ExpensesDashboard.jsx
  var import_react2 = __toESM(require_react());

  // node_modules/react-frappe-charts/build/index.js
  ...
  function styleInject(t7, e) {
    void 0 === e && (e = {});
    var n = e.insertAt;
    if (t7 && "undefined" != typeof document) {
      var i = document.head || document.getElementsByTagName("head")[0], a = document.createElement("style");
      a.type = "text/css", "top" === n && i.firstChild ? i.insertBefore(a, i.firstChild) : i.appendChild(a), a.styleSheet ? a.styleSheet.cssText = t7 : a.appendChild(document.createTextNode(t7));
    }
  }
  function $(t7, e) {
    return "string" == typeof t7 ? (e || document).querySelector(t7) : t7 || null;
  }
  ...
  function _classCallCheck$4(t7, e) {
    if (!(t7 instanceof e)) throw new TypeError("Cannot call a class as a function");
  }
  ...
  function isValidNumber(t7) {
    ...
    return !Number.isNaN(t7) && (void 0 !== t7 && (!!Number.isFinite(t7) && !(e && t7 < 0)));
  }
  function round(t7) {
  ...
  function deepClone(t7) {
    ...
    if (t7 instanceof Date) return new Date(t7.getTime());
    if ("object" !== (void 0 === t7 ? "undefined" : _typeof$2(t7)) || null === t7) return t7;
    e = Array.isArray(t7) ? [] : {};
    for (i in t7) n = t7[i], e[i] = deepClone(n);
    return e;
  }
  ...
  function equilizeNoOfElements(t7, e) {
    var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : e.length - t7.length;
    return n > 0 ? t7 = fillArray(t7, n) : e = fillArray(e, n), [t7, e];
  }
  function truncateString(t7, e) {
    if (t7) return t7.length > e ? t7.slice(0, e - 3) + "..." : t7;
  }
  function shortenLargeNumber(t7) {
    var e = void 0;
    if ("number" == typeof t7) e = t7;
    else if ("string" == typeof t7 && (e = Number(t7), Number.isNaN(e))) return t7;
  ...
  function getSplineCurvePointsStr(t7, e) {
    for (var n = [], i = 0; i < t7.length; i++) n.push([t7[i], e[i]]);
    ...
    return (function(t8, e2) {
      return t8.reduce(function(t9, n2, i2, a2) {
        return 0 === i2 ? n2[0] + "," + n2[1] : t9 + " " + e2(n2, i2, a2);
      }, "");
    })(n, function(t8, e2, n2) {
  ...
  function createSVG(t7, e) {
    ...
    for (var i in e) {
      ...
      } else "styles" === i ? "object" === (void 0 === a ? "undefined" : _typeof$1(a)) && Object.keys(a).map(function(t8) {
        n.style[t8] = a[t8];
  ...
  function makeSVGGroup(t7) {
    var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "", n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : void 0, i = { className: t7, transform: e };
    return n && (i.inside = n), createSVG("g", i);
  }
  function makePath(t7) {
    return createSVG("path", { className: arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "", d: t7, styles: { stroke: arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "none", fill: arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "none", "stroke-width": arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 2 } });
  }
  function makeArcPathStr(t7, e, n, i) {
    var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 1, r = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : 0, o = n.x + t7.x, s = n.y + t7.y, l = n.x + e.x, u = n.y + e.y;
    return "M" + n.x + " " + n.y + "\n		L" + o + " " + s + "\n		A " + i + " " + i + " 0 " + r + " " + (a ? 1 : 0) + "\n		" + l + " " + u + " z";
  }
  function makeCircleStr(t7, e, n, i) {
    var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 1, r = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : 0, o = n.x + t7.x, s = n.y + t7.y, l = n.x + e.x, u = 2 * n.y, c = n.y + e.y;
    return "M" + n.x + " " + n.y + "\n		L" + o + " " + s + "\n		A " + i + " " + i + " 0 " + r + " " + (a ? 1 : 0) + "\n		" + l + " " + u + " z\n		L" + o + " " + u + "\n		A " + i + " " + i + " 0 " + r + " " + (a ? 1 : 0) + "\n		" + l + " " + c + " z";
  }
  ...
  function makeStrokeCircleStr(t7, e, n, i) {
    var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 1, r = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : 0, o = n.x + t7.x, s = n.y + t7.y, l = n.x + e.x, u = 2 * i + s, c = n.y + t7.y;
    return "M" + o + " " + s + "\n		A " + i + " " + i + " 0 " + r + " " + (a ? 1 : 0) + "\n		" + l + " " + u + "\n		M" + o + " " + u + "\n		A " + i + " " + i + " 0 " + r + " " + (a ? 1 : 0) + "\n		" + l + " " + c;
  }
  function makeGradient(t7, e) {
    var n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], i = "path-fill-gradient-" + e + "-" + (n ? "lighter" : "default"), a = renderVerticalGradient(t7, i), r = [1, 0.6, 0.2];
  ...
  function heatSquare(t7, e, n, i, a) {
    var r = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : "none", o = arguments.length > 6 && void 0 !== arguments[6] ? arguments[6] : {}, s = { className: t7, x: e, y: n, width: i, height: i, rx: a, fill: r };
  ...
  function makeText(t7, e, n, i) {
    ...
    return createSVG("text", { className: t7, x: e, y: n, dy: (void 0 !== a.dy ? a.dy : r / 2) + "px", "font-size": r + "px", fill: a.fill || FONT_FILL, "text-anchor": a.textAnchor || "start", innerHTML: i });
  }
  ...
  function makeHoriLine(t7, e, n, i) {
    ...
    var r = createSVG("line", { className: "line-horizontal " + a.className + ("dashed" === a.lineType ? "dashed" : ""), x1: n, x2: i, y1: 0, y2: 0, styles: { stroke: a.stroke } }), o = createSVG("text", { x: n < i ? n - LABEL_MARGIN : n + LABEL_MARGIN, y: 0, dy: FONT_SIZE / 2 - 2 + "px", "font-size": FONT_SIZE + "px", "text-anchor": n < i ? "end" : "start", innerHTML: e + "" }), s = createSVG("g", { transform: "translate(0, " + t7 + ")", "stroke-opacity": 1 });
  ...
  function yLine(t7, e, n) {
    ...
    return "tick" === i.mode && "right" === i.pos && (a = n + AXIS_TICK_LENGTH, r = n), a += i.offset, r += i.offset, makeHoriLine(t7, e, a, r, { stroke: i.stroke, className: i.className, lineType: i.lineType, shortenNumbers: i.shortenNumbers });
  }
  function xLine(t7, e, n) {
    ...
    return "tick" === i.mode && "top" === i.pos && (a = -1 * AXIS_TICK_LENGTH, r = 0), makeVertLine(t7, e, a, r, { stroke: i.stroke, className: i.className, lineType: i.lineType });
  }
  function yMarker(t7, e, n) {
    var i = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {};
    i.labelPos || (i.labelPos = "right");
    var a = createSVG("text", { className: "chart-label", x: "left" === i.labelPos ? LABEL_MARGIN : n - getStringWidth(e, 5) - LABEL_MARGIN, y: 0, dy: FONT_SIZE / -2 + "px", "font-size": FONT_SIZE + "px", "text-anchor": "start", innerHTML: e + "" }), r = makeHoriLine(t7, "", 0, n, { stroke: i.stroke || BASE_LINE_COLOR, className: i.className || "", lineType: i.lineType });
    return r.appendChild(a), r;
  }
  function yRegion(t7, e, n, i) {
    var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : {}, r = t7 - e, o = createSVG("rect", { className: "bar mini", styles: { fill: "rgba(228, 234, 239, 0.49)", stroke: BASE_LINE_COLOR, "stroke-dasharray": n + ", " + r }, x: 0, y: 0, width: n, height: r });
    a.labelPos || (a.labelPos = "right");
    var s = createSVG("text", { className: "chart-label", x: "left" === a.labelPos ? LABEL_MARGIN : n - getStringWidth(i + "", 4.5) - LABEL_MARGIN, y: 0, dy: FONT_SIZE / -2 + "px", "font-size": FONT_SIZE + "px", "text-anchor": "start", innerHTML: i + "" }), l = createSVG("g", { transform: "translate(0, " + e + ")" });
  ...
  function datasetBar(t7, e, n, i) {
    ...
    h -= o, 0 === c && (c = s.minHeight, h -= s.minHeight), isValidNumber(t7) || (t7 = 0), isValidNumber(h) || (h = 0), isValidNumber(c, true) || (c = 0), isValidNumber(n, true) || (n = 0);
  ...
  function datasetDot(t7, e, n, i) {
    var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : "", r = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : 0, o = createSVG("circle", { style: "fill: " + i, "data-point-index": r, cx: t7, cy: e, r: n });
    if ((a += "") || a.length) {
  ...
  function getPaths(t7, e, n) {
    var i = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {}, a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : {}, r = e.map(function(e2, n2) {
      return t7[n2] + "," + e2;
    }).join("L");
  ...
  function animateBar(t7, e, n, i) {
    ...
    return l -= a, "rect" !== t7.nodeName ? [[t7.childNodes[0], { width: i, height: s }, UNIT_ANIM_DUR, STD_EASING], translate(t7, t7.getAttribute("transform").split("(")[1].slice(0, -1), [e, l], MARKER_LINE_ANIM_DUR)] : [[t7, { width: i, height: s, x: e, y: l }, UNIT_ANIM_DUR, STD_EASING]];
  }
  function animateDot(t7, e, n) {
    return "circle" !== t7.nodeName ? [translate(t7, t7.getAttribute("transform").split("(")[1].slice(0, -1), [e, n], MARKER_LINE_ANIM_DUR)] : [[t7, { cx: e, cy: n }, UNIT_ANIM_DUR, STD_EASING]];
  }
  ...
  function _toConsumableArray$1(t7) {
    if (Array.isArray(t7)) {
      for (var e = 0, n = Array(t7.length); e < t7.length; e++) n[e] = t7[e];
      return n;
    }
    return Array.from(t7);
  }
  function animateSVGElement(t7, e, n) {
    var i = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "linear", a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : void 0, r = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : {}, o = t7.cloneNode(true), s = t7.cloneNode(true);
    for (var l in e) {
      var u = void 0;
  ...
  function _possibleConstructorReturn$1(t7, e) {
    ...
    return !e || "object" != typeof e && "function" != typeof e ? t7 : e;
  }
  ...
  function getMonthName(t7) {
    var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], n = MONTH_NAMES[t7];
  ...
  function normalize(t7) {
    if (0 === t7) return [0, 0];
    if (isNaN(t7)) return { mantissa: -6755399441055744, exponent: 972 };
    var e = t7 > 0 ? 1 : -1;
    if (!isFinite(t7)) return { mantissa: 4503599627370496 * e, exponent: 972 };
    t7 = Math.abs(t7);
    var n = Math.floor(Math.log10(t7));
    return [e * (t7 / Math.pow(10, n)), n];
  }
  function getChartRangeIntervals(t7) {
    var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0, n = Math.ceil(t7), i = Math.floor(e), a = n - i, r = a, o = 1;
    a > 5 && (a % 2 != 0 && (a = ++n - i), r = a / 2, o = 2), a <= 2 && (o = a / (r = 4)), 0 === a && (r = 5, o = 1);
    for (var s = [], l = 0; l <= r; l++) s.push(i + o * l);
    return s;
  }
  function getChartIntervals(t7) {
    var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0, n = normalize(t7), i = _slicedToArray$4(n, 2), a = i[0], r = i[1], o = e ? e / Math.pow(10, r) : 0, s = getChartRangeIntervals(a = a.toFixed(6), o);
  ...
  function calcChartIntervals(t7) {
    function e(t8, e2) {
      for (var n2 = getChartIntervals(t8), i2 = n2[1] - n2[0], a2 = 0, r2 = 1; a2 < e2; r2++) a2 += i2, n2.unshift(-1 * a2);
      return n2;
    }
    var n = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], i = Math.max.apply(Math, _toConsumableArray$4(t7)), a = Math.min.apply(Math, _toConsumableArray$4(t7)), r = [];
  ...
  function getClosestInArray(t7, e) {
    var n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], i = e.reduce(function(e2, n2) {
  ...
  function getShortenedLabels(t7) {
    var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [], n = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2], i = t7 / e.length;
    i <= 0 && (i = 1);
  ...
  function getChartByType() {
    var t7 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "line", e = arguments[1], n = arguments[2];
    return "axis-mixed" === t7 ? (n.type = "line", new AxisChart(e, n)) : chartTypes[t7] ? new chartTypes[t7](e, n) : void console.error("Undefined chart type: " + t7);
  }
  ...
  var _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t7) {
    return typeof t7;
  } : function(t7) {
  ...
  $.create = function(t7, e) {
    ...
    for (var i in e) {
      ...
      if ("inside" === i) $(a).appendChild(n);
        ...
        var r = $(a);
        r.parentNode.insertBefore(n, r), n.appendChild(r);
      } else "styles" === i ? "object" === (void 0 === a ? "undefined" : _typeof(a)) && Object.keys(a).map(function(t8) {
        n.style[t8] = a[t8];
  ...
  var SvgTip = (function() {
    ...
    return _createClass$3(t7, [{ key: "setup", value: function() {
      ...
      this.index && this.container.setAttribute("data-point-index", this.index), e = this.titleValueFirst ? "<strong>" + this.titleValue + "</strong>" + this.titleName : this.titleName + "<strong>" + this.titleValue + "</strong>", this.title.innerHTML = e, this.dataPointList.innerHTML = "", this.listValues.map(function(e2, n) {
        var i = t8.colors[n] || "black", a = 0 === e2.formatted || e2.formatted ? e2.formatted : e2.value, r = $.create("li", { styles: { "border-top": "3px solid " + i }, innerHTML: '<strong style="display: block;">' + (0 === a || a ? a : "") + "</strong>\n					" + (e2.title ? e2.title : "") });
  ...
  var _typeof$2 = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t7) {
    return typeof t7;
  } : function(t7) {
    return t7 && "function" == typeof Symbol && t7.constructor === Symbol && t7 !== Symbol.prototype ? "symbol" : typeof t7;
  };
  ...
  var getColor = function(t7) {
    return /rgb[a]{0,1}\([\d, ]+\)/gim.test(t7) ? /\D+(\d*)\D+(\d*)\D+(\d*)/gim.exec(t7).map(function(t8, e) {
      return 0 !== e ? Number(t8).toString(16) : "#";
  ...
  var _slicedToArray = /* @__PURE__ */ (function() {
    ...
    return function(e, n) {
      ...
      if (Symbol.iterator in Object(e)) return t7(e, n);
      throw new TypeError("Invalid attempt to destructure non-iterable instance");
    };
  })();
  var _typeof$1 = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t7) {
    return typeof t7;
  } : function(t7) {
    return t7 && "function" == typeof Symbol && t7.constructor === Symbol && t7 !== Symbol.prototype ? "symbol" : typeof t7;
  };
  ...
  var makeOverlay = { bar: function(t7) {
    var e = void 0;
    "rect" !== t7.nodeName && (e = t7.getAttribute("transform"), t7 = t7.childNodes[0]);
    var n = t7.cloneNode();
    return n.style.fill = "#000000", n.style.opacity = "0.4", e && n.setAttribute("transform", e), n;
  }, dot: function(t7) {
    var e = void 0;
    "circle" !== t7.nodeName && (e = t7.getAttribute("transform"), t7 = t7.childNodes[0]);
  ...
  var updateOverlay = { bar: function(t7, e) {
    var n = void 0;
    "rect" !== t7.nodeName && (n = t7.getAttribute("transform"), t7 = t7.childNodes[0]);
    ...
    var n = void 0;
    "circle" !== t7.nodeName && (n = t7.getAttribute("transform"), t7 = t7.childNodes[0]);
    var i = ["cx", "cy"];
    Object.values(t7.attributes).filter(function(t8) {
      return i.includes(t8.name) && t8.specified;
    }).map(function(t8) {
  ...
  var BaseChart = (function() {
    function t7(e, n) {
      if (_classCallCheck$3(this, t7), n = deepClone(n), this.parent = "string" == typeof e ? document.querySelector(e) : e, !(this.parent instanceof HTMLElement)) throw new Error("No `parent` element to render on was provided.");
    ...
    return _createClass$2(t7, [{ key: "prepareData", value: function(t8) {
      ...
      var t8 = this, e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0], n = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
      ...
      var t8 = this, e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.components, n = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
      ...
      var t8 = this, e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
  ...
  var ChartComponent = (function() {
    function t7(e) {
      ...
      _classCallCheck$5(this, t7), this.layerTransform = r, this.constants = o, this.makeElements = l, this.getData = s, this.animateElements = u, this.store = [], this.labels = [], this.layerClass = i, this.layerClass = "function" == typeof this.layerClass ? this.layerClass() : this.layerClass, this.refresh();
    }
  ...
  var componentConfigs = { donutSlices: { layerClass: "donut-slices", makeElements: function(t7) {
    ...
    return this.serializedSubDomains = [], t7.cols.map(function(t8, n2) {
      1 === n2 && e.labels.push(makeText("domain-name", l, -12, getMonthName(i, true).toUpperCase(), { fontSize: 9 })), t8.map(function(t9, n3) {
        if (t9.fill) {
  ...
  var PieChart = (function(t7) {
    ...
    return _inherits$2(e, t7), _createClass$5(e, [{ key: "configure", value: function(t8) {
      ...
      n.sliceTotals.map(function(e2, s) {
        ...
        var m = 360 === u ? makeCircleStr(g, y, t8.center, t8.radius, a, c) : makeArcPathStr(g, y, t8.center, t8.radius, a, c);
      ...
      if (t8) {
        ...
        } else transform(t8, "translate3d(0,0,0)"), this.tip.hideTip(), t8.style.fill = a;
      }
    } }, { key: "bindTooltip", value: function() {
  ...
  var Heatmap = (function(t7) {
    ...
    return _inherits$3(e, t7), _createClass$6(e, [{ key: "setMeasures", value: function(t8) {
      var e2 = this.measures;
      this.discreteDomains = 0 === t8.discreteDomains ? 0 : 1, e2.paddings.top = 3 * ROW_HEIGHT, e2.paddings.bottom = 0, e2.legendHeight = 2 * ROW_HEIGHT, e2.baseHeight = ROW_HEIGHT * NO_OF_DAYS_IN_WEEK + getExtraHeight(e2);
      ...
      var t8 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.data;
      if (t8.start && t8.end && t8.start > t8.end) throw new Error("Start date cannot be greater than end date.");
      if (t8.start || (t8.start = /* @__PURE__ */ new Date(), t8.start.setFullYear(t8.start.getFullYear() - 1)), t8.end || (t8.end = /* @__PURE__ */ new Date()), t8.dataPoints = t8.dataPoints || {}, parseInt(Object.keys(t8.dataPoints)[0]) > 1e5) {
        var e2 = {};
      ...
      var e2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "", n = [t8.getMonth(), t8.getFullYear()], i = n[0], a = n[1], r = setDayToSunday(t8), o = { index: i, cols: [] };
      addDays(e2 = clone(e2) || getLastDateInMonth(i, a), 1);
      for (var s = getWeeksBetween(r, e2), l = [], u = void 0, c = 0; c < s; c++) u = this.getCol(r, i), l.push(u), addDays(r = new Date(u[NO_OF_DAYS_IN_WEEK - 1].yyyyMmDd), 1);
      return void 0 !== u[NO_OF_DAYS_IN_WEEK - 1].dataValue && (addDays(r, 1), l.push(this.getCol(r, i, true))), o.cols = l, o;
    } }, { key: "getCol", value: function(t8, e2) {
      for (var n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], i = this.state, a = clone(t8), r = [], o = 0; o < NO_OF_DAYS_IN_WEEK; o++, addDays(a, 1)) {
  ...
  var AxisChart = (function(t7) {
    ...
    return _inherits$4(e, t7), _createClass$7(e, [{ key: "setMeasures", value: function() {
      ...
      var t8 = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
      this.calcXPositions(), t8 || this.calcYAxisParameters(this.getAllYValues(), "line" === this.type), this.makeDataByIndex();
      ...
      var e2 = calcChartIntervals(t8, arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "false"), n = this.height / getValueRange(e2), i = getIntervalSize(e2) * n, a = this.height - getZeroIndex(e2) * i;
      ...
      var t8 = this.state;
      if (this.barOptions.stacked) return void (t8.yExtremes = t8.datasets[t8.datasets.length - 1].cumulativeYPos);
      ...
      var t8 = this, e2 = [["yAxis", { mode: this.config.yAxisMode, width: this.width, shortenNumbers: this.config.shortenYAxisNumbers }, function() {
        ...
        return "bar" === t9.chartType;
      }), i = this.state.datasets.filter(function(t9) {
        return "line" === t9.chartType;
      }), a = n.map(function(e3) {
        var i2 = e3.index;
      ...
      var t8 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.state.currentIndex, e2 = this.state;
      ...
      var t8 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.state.datasetLength - 1;
  ...
  var DonutChart = (function(t7) {
    ...
    return _inherits$5(e, t7), _createClass$8(e, [{ key: "configure", value: function(t8) {
      ...
      n.sliceTotals.map(function(e2, s) {
        var l = o, u = e2 / n.grandTotal * FULL_ANGLE, c = u > 180 ? 1 : 0, h = a ? -u : u, d = o += h, f = getPositionByAngle(l, i), p = getPositionByAngle(d, i), v = t8.init && r[s], g = void 0, y = void 0;
        t8.init ? (g = v ? v.startPosition : f, y = v ? v.endPosition : f) : (g = f, y = p);
        var m = 360 === u ? makeStrokeCircleStr(g, y, t8.center, t8.radius, t8.clockWise, c) : makeArcStrokePathStr(g, y, t8.center, t8.radius, t8.clockWise, c);
        n.sliceStrings.push(m), n.slicesProperties.push({ startPosition: f, endPosition: p, value: e2, total: n.grandTotal, startAngle: l, endAngle: d, angle: h });
      }), this.init = 0;
    } }, { key: "setupComponents", value: function() {
      ...
      if (t8) {
        ...
        if (n) {
          ...
          var r = getOffset(this.svg), o = i.pageX - r.left + 10, s = i.pageY - r.top - 10, l = (this.formatted_labels && this.formatted_labels.length > 0 ? this.formatted_labels[e2] : this.state.labels[e2]) + ": ", u = (100 * this.state.sliceTotals[e2] / this.state.grandTotal).toFixed(1);
          this.tip.setValues(o, s, { name: l, value: u + "%" }), this.tip.showTip();
        } else transform(t8, "translate3d(0,0,0)"), this.tip.hideTip(), t8.style.stroke = a;
      }
    } }, { key: "bindTooltip", value: function() {
      this.container.addEventListener("mousemove", this.mouseMove), this.container.addEventListener("mouseleave", this.mouseLeave);
    } }, { key: "mouseMove", value: function(t8) {
  ...
  // node_modules/react-frappe-charts/build/index.js
  var ReactFrappeChart = (0, import_react.forwardRef)((props, parentRef) => {
    const ref = import_react.default.useRef(null);
    const chart = import_react.default.useRef(null);
    const initialRender = import_react.default.useRef(true);
    const { onDataSelect } = props;
    (0, import_react.useImperativeHandle)(parentRef, () => ({
      export: () => {
    ...
    import_react.default.useEffect(() => {
      chart.current = new Chart(ref.current, Object.assign({ isNavigable: onDataSelect !== void 0 }, props));
      if (onDataSelect) {
  ...
  var build_default = ReactFrappeChart;

  // expenses_management/public/js/react_dashboard/ExpensesDashboard.jsx
  var ExpensesDashboard = () => {
    const [dashboardData, setDashboardData] = (0, import_react2.useState)(null);
    ...
    const [filterOptions, setFilterOptions] = (0, import_react2.useState)({
      companies: [],
      cost_centers: [],
      expense_types: []
    });
        ...
        callback: (r) => {
          if (r.message) {
            ...
            if (r.message.companies.length > 0) {
              setFilters((prev) => __spreadProps(__spreadValues({}, prev), { company: r.message.companies[0] }));
            }
          }
        }
      });
    ...
    const handleFilterChange = (field, value) => {
      setFilters((prev) => __spreadProps(__spreadValues({}, prev), { [field]: value }));
    };
    ...
    if (loading) {
      return /* @__PURE__ */ import_react2.default.createElement("div", { className: "text-center", style: { padding: "50px" } }, /* @__PURE__ */ import_react2.default.createElement("i", { className: "fa fa-spinner fa-spin fa-3x" }));
    }
    if (error) {
      return /* @__PURE__ */ import_react2.default.createElement("div", { className: "text-center text-danger", style: { padding: "50px" } }, error);
    }
    if (!dashboardData) {
      return /* @__PURE__ */ import_react2.default.createElement("div", { className: "text-center text-muted", style: { padding: "50px" } }, "No data available");
    }
    return /* @__PURE__ */ import_react2.default.createElement("div", { className: "expenses-dashboard-react", style: { padding: "15px" } }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "card", style: { border: "1px solid #d1d8dd", borderRadius: "4px", padding: "20px", marginBottom: "15px" } }, /* @__PURE__ */ import_react2.default.createElement("h5", { style: { marginBottom: "15px" } }, "Filters"), /* @__PURE__ */ import_react2.default.createElement("div", { className: "row" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "col-sm-3" }, /* @__PURE__ */ import_react2.default.createElement("label", null, "Company"), /* @__PURE__ */ import_react2.default.createElement(
      "select",
      {
      ...
      filterOptions.companies.map((company) => /* @__PURE__ */ import_react2.default.createElement("option", { key: company, value: company }, company))
    )), /* @__PURE__ */ import_react2.default.createElement("div", { className: "col-sm-2" }, /* @__PURE__ */ import_react2.default.createElement("label", null, "From Date"), /* @__PURE__ */ import_react2.default.createElement(
      "input",
      {
        type: "date",
        className: "form-control",
    ...
    )), /* @__PURE__ */ import_react2.default.createElement("div", { className: "col-sm-2" }, /* @__PURE__ */ import_react2.default.createElement("label", null, "To Date"), /* @__PURE__ */ import_react2.default.createElement(
      "input",
      {
        type: "date",
        className: "form-control",
    ...
    )), /* @__PURE__ */ import_react2.default.createElement("div", { className: "col-sm-2" }, /* @__PURE__ */ import_react2.default.createElement("label", null, "Cost Center"), /* @__PURE__ */ import_react2.default.createElement(
      "select",
      {
        className: "form-control",
      ...
      /* @__PURE__ */ import_react2.default.createElement("option", { value: "" }, "All"),
      filterOptions.cost_centers.map((cc) => /* @__PURE__ */ import_react2.default.createElement("option", { key: cc, value: cc }, cc))
    )), /* @__PURE__ */ import_react2.default.createElement("div", { className: "col-sm-2" }, /* @__PURE__ */ import_react2.default.createElement("label", null, "Expense Type"), /* @__PURE__ */ import_react2.default.createElement(
      "select",
      {
        className: "form-control",
      ...
      /* @__PURE__ */ import_react2.default.createElement("option", { value: "" }, "All"),
      filterOptions.expense_types.map((type) => /* @__PURE__ */ import_react2.default.createElement("option", { key: type, value: type }, type))
    )), /* @__PURE__ */ import_react2.default.createElement("div", { className: "col-sm-1", style: { paddingTop: "24px" } }, /* @__PURE__ */ import_react2.default.createElement(
      "button",
      {
        className: "btn btn-primary btn-sm",
        onClick: () => setFilters((prev) => __spreadValues({}, prev))
      },
      /* @__PURE__ */ import_react2.default.createElement("i", { className: "fa fa-refresh" })
    )))), /* @__PURE__ */ import_react2.default.createElement("div", { className: "row" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "col-sm-3" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "card", style: { border: "1px solid #d1d8dd", borderRadius: "4px", padding: "20px", marginBottom: "15px" } }, /* @__PURE__ */ import_react2.default.createElement("h6", { style: { marginBottom: "10px", color: "#6c757d" } }, "Total Expenses"), /* @__PURE__ */ import_react2.default.createElement("h3", { style: { marginBottom: "5px", color: "#2c3e50" } }, formatCurrency(dashboardData.current_period.total)), /* @__PURE__ */ import_react2.default.createElement("div", { style: { color: dashboardData.current_period.change >= 0 ? "#28a745" : "#dc3545", fontSize: "12px" } }, /* @__PURE__ */ import_react2.default.createElement("i", { className: `fa fa-arrow-${dashboardData.current_period.change >= 0 ? "up" : "down"}` }), " ", Math.abs(dashboardData.current_period.change).toFixed(1), "% vs previous"))), /* @__PURE__ */ import_react2.default.createElement("div", { className: "col-sm-3" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "card", style: { border: "1px solid #d1d8dd", borderRadius: "4px", padding: "20px", marginBottom: "15px" } }, /* @__PURE__ */ import_react2.default.createElement("h6", { style: { marginBottom: "10px", color: "#6c757d" } }, "Year to Date"), /* @__PURE__ */ import_react2.default.createElement("h3", { style: { marginBottom: "5px", color: "#2c3e50" } }, formatCurrency(dashboardData.year_to_date.total)), /* @__PURE__ */ import_react2.default.createElement("div", { style: { color: "#6c757d", fontSize: "12px" } }, "Total this year"))), /* @__PURE__ */ import_react2.default.createElement("div", { className: "col-sm-3" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "card", style: { border: "1px solid #d1d8dd", borderRadius: "4px", padding: "20px", marginBottom: "15px" } }, /* @__PURE__ */ import_react2.default.createElement("h6", { style: { marginBottom: "10px", color: "#6c757d" } }, "Expense Count"), /* @__PURE__ */ import_react2.default.createElement("h3", { style: { marginBottom: "5px", color: "#2c3e50" } }, dashboardData.stats.count), /* @__PURE__ */ import_react2.default.createElement("div", { style: { color: "#6c757d", fontSize: "12px" } }, "Total entries"))), /* @__PURE__ */ import_react2.default.createElement("div", { className: "col-sm-3" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "card", style: { border: "1px solid #d1d8dd", borderRadius: "4px", padding: "20px", marginBottom: "15px" } }, /* @__PURE__ */ import_react2.default.createElement("h6", { style: { marginBottom: "10px", color: "#6c757d" } }, "Average Expense"), /* @__PURE__ */ import_react2.default.createElement("h3", { style: { marginBottom: "5px", color: "#2c3e50" } }, formatCurrency(dashboardData.stats.average)), /* @__PURE__ */ import_react2.default.createElement("div", { style: { color: "#6c757d", fontSize: "12px" } }, "Per entry")))), /* @__PURE__ */ import_react2.default.createElement("div", { className: "row" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "col-sm-12" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "card", style: { border: "1px solid #d1d8dd", borderRadius: "4px", padding: "20px", marginBottom: "15px" } }, /* @__PURE__ */ import_react2.default.createElement("h5", { style: { marginBottom: "15px" } }, "Monthly Trend"), dashboardData.monthly_trend && dashboardData.monthly_trend.length > 0 ? /* @__PURE__ */ import_react2.default.createElement(
      build_default,
      {
        type: "line",
        data: {
    ...
    ) : /* @__PURE__ */ import_react2.default.createElement("p", { className: "text-muted text-center" }, "No data available")))), /* @__PURE__ */ import_react2.default.createElement("div", { className: "row" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "col-sm-6" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "card", style: { border: "1px solid #d1d8dd", borderRadius: "4px", padding: "20px", marginBottom: "15px" } }, /* @__PURE__ */ import_react2.default.createElement("h5", { style: { marginBottom: "15px" } }, "Top Expenses by Type"), dashboardData.expenses_by_type && dashboardData.expenses_by_type.length > 0 ? /* @__PURE__ */ import_react2.default.createElement(
      build_default,
      {
        type: "pie",
        data: {
    ...
    ) : /* @__PURE__ */ import_react2.default.createElement("p", { className: "text-muted text-center" }, "No data available"))), /* @__PURE__ */ import_react2.default.createElement("div", { className: "col-sm-6" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "card", style: { border: "1px solid #d1d8dd", borderRadius: "4px", padding: "20px", marginBottom: "15px" } }, /* @__PURE__ */ import_react2.default.createElement("h5", { style: { marginBottom: "15px" } }, "Expenses by Cost Center"), dashboardData.expenses_by_cost_center && dashboardData.expenses_by_cost_center.length > 0 ? /* @__PURE__ */ import_react2.default.createElement(
      build_default,
      {
        type: "bar",
        data: {
    ...
    ) : /* @__PURE__ */ import_react2.default.createElement("p", { className: "text-muted text-center" }, "No data available")))), /* @__PURE__ */ import_react2.default.createElement("div", { className: "row" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "col-sm-12" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "card", style: { border: "1px solid #d1d8dd", borderRadius: "4px", padding: "20px", marginBottom: "15px" } }, /* @__PURE__ */ import_react2.default.createElement("h5", { style: { marginBottom: "15px" } }, "Top 10 Expenses"), dashboardData.top_expenses && dashboardData.top_expenses.length > 0 ? /* @__PURE__ */ import_react2.default.createElement("table", { className: "table table-bordered" }, /* @__PURE__ */ import_react2.default.createElement("thead", null, /* @__PURE__ */ import_react2.default.createElement("tr", null, /* @__PURE__ */ import_react2.default.createElement("th", null, "Entry"), /* @__PURE__ */ import_react2.default.createElement("th", null, "Date"), /* @__PURE__ */ import_react2.default.createElement("th", null, "Amount"), /* @__PURE__ */ import_react2.default.createElement("th", null, "Cost Center"), /* @__PURE__ */ import_react2.default.createElement("th", null, "Remarks"))), /* @__PURE__ */ import_react2.default.createElement("tbody", null, dashboardData.top_expenses.map((expense, idx) => /* @__PURE__ */ import_react2.default.createElement("tr", { key: idx }, /* @__PURE__ */ import_react2.default.createElement("td", null, /* @__PURE__ */ import_react2.default.createElement("a", { href: `/app/expense-entry/${expense.name}`, target: "_blank", rel: "noopener noreferrer" }, expense.name)), /* @__PURE__ */ import_react2.default.createElement("td", null, expense.posting_date), /* @__PURE__ */ import_react2.default.createElement("td", null, formatCurrency(expense.total_amount)), /* @__PURE__ */ import_react2.default.createElement("td", null, expense.cost_center || "-"), /* @__PURE__ */ import_react2.default.createElement("td", null, expense.remarks || "-"))))) : /* @__PURE__ */ import_react2.default.createElement("p", { className: "text-muted text-center" }, "No data available")))));
  };
  var ExpensesDashboard_default = ExpensesDashboard;
  ...
  window.mountExpensesDashboard = function(container) {
    ...
    root.render(/* @__PURE__ */ import_react3.default.createElement(ExpensesDashboard_default, null));
  };
...
react-dom/cjs/react-dom-client.production.js:
   ...
   *)
*/
//# sourceMappingURL=expenses_dashboard_react.bundle.js.map
